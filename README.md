...
<p align="center">
  ...
  <p align="center">
    <br />
    <a href="https://github.com/fwzfrds/blanja"><strong>Explore the docs »</strong></a>
    <br />
    <br />
...
Blanja Rest API, is REST API used in [`Blanja`](https://blanja-app-fwzfrds.vercel.app). This API handle user (customer), admin (seller), and products in this web app. 
...
1. Clone the repo
```sh
git clone https://github.com/fwzfrds/blanja.git
```
